...
INSERT INTO berita (judul, slug, kategori, ringkasan, icon, tanggal, status) VALUES
('Jadwal PPDB Tahun Ajaran 2025/2026 Resmi Dibuka', 'ppdb-2025-2026', 'pengumuman', 'Pendaftaran PPDB dibuka mulai 1 Juni hingga 30 Juni 2025. Persyaratan dan tata cara pendaftaran dapat diunduh di website sekolah atau diambil langsung di kantor TU.', '📢', '2025-05-15', 'publish'),
('Siswa SDN Ketapang Raih Juara I Olimpiade Matematika Kecamatan', 'juara-olimpiade-matematika', 'berita', 'Kebanggaan bagi SDN Ketapang! Riko Andrianto kelas V berhasil meraih Juara I dalam Olimpiade Matematika tingkat Kecamatan yang diikuti 45 peserta dari 15 sekolah.', '🏆', '2025-05-10', 'publish'),
('Peringatan Hari Kartini: Pentas Seni dan Lomba Busana Daerah', 'hari-kartini-2025', 'kegiatan', 'SDN Ketapang menggelar serangkaian kegiatan memperingati Hari Kartini dengan penuh semangat dan kreativitas. Seluruh siswa mengenakan busana daerah dari berbagai penjuru Nusantara.', '🎨', '2025-04-21', 'publish'),
('Jadwal Ujian Kenaikan Kelas Semester Genap 2024/2025', 'ukk-semester-genap-2025', 'pengumuman', 'Kepada seluruh siswa agar mempersiapkan diri menghadapi Ujian Kenaikan Kelas yang akan dilaksanakan pada 9–13 Juni 2025. Jadwal lengkap dapat dilihat di papan pengumuman sekolah.', '📝', '2025-05-01', 'publish'),
('Kemah Pramuka Gabungan Se-Kecamatan di Bumi Perkemahan Riam Kanan', 'kemah-pramuka-2025', 'kegiatan', 'Siswa kelas IV–VI mengikuti Kemah Pramuka Gabungan selama 3 hari 2 malam. Berbagai kegiatan kepramukaan diikuti dengan antusias tinggi.', '⛺', '2025-04-05', 'publish'),
('Program Literasi "Satu Hari Satu Buku" Resmi Diluncurkan', 'literasi-satu-hari-satu-buku', 'berita', 'SDN Ketapang meluncurkan program literasi baru untuk meningkatkan minat baca siswa. Program ini didukung penuh oleh komite sekolah dan orang tua murid.', '📚', '2025-03-20', 'publish');
